 ...
 */
extern int8 rtl8306e_reg_set(uint8 phyad, uint8 regad, uint8 npage, uint16 value) ;
 ...
 *      to modify them,  you can port all asic API to other platform.
 */
extern int8 rtl8306e_reg_get(uint8 phyad, uint8 regad, uint8 npage, uint16 *pvalue);
 ...
 */
extern int8 rtl8306e_regbit_set(uint8 phyad, uint8 regad, uint8 pos, uint8 npage,  uint8 value);
 ...
 */
extern int8 rtl8306e_regbit_get(uint8 phyad, uint8 regad, uint8 pos, uint8 npage,  uint8 * pvalue) ;
 ...
 *      to modify them,  you can port all asic API to other platform.
 */
extern int8 rtl8306e_phyReg_set(uint8 phyad, uint8 regad, uint8 npage, uint16 value);
 ...
 *      to modify them,  you can port all asic API to other platform.
 */
extern int8 rtl8306e_phyReg_get(uint8 phyad, uint8 regad, uint8 npage, uint16 *pvalue);

extern int8 rtl8306e_asic_checkOUI(void);
extern int8 rtl8306e_asic_init(void);
 ...
 * Note:
 */
extern int8 rtl8306e_phy_reset(uint8 phy);
 ...
 *              
 */ 
extern int8 rtl8306e_switch_maxPktLen_set(uint8 maxLen);
 ...
 *              
 */ 
extern int8 rtl8306e_switch_maxPktLen_get(uint8 *pMaxLen);
...
extern int8 rtl8306e_port_etherPhy_set(uint8 phy, uint8 autoNegotiation, uint8 advCapability, uint8 speed, uint8 fullDuplex) ;
 ...
 *      Speed should be either RTL8306_ETHER_SPEED_100 or RTL8306_ETHER_SPEED_10.
 */
extern int8 rtl8306e_port_etherPhy_get(uint8 phy, uint8 *pAutoNegotiation, uint8 *pAdvCapability, uint8 *pSpeed, uint8 *pFullDuplex);
 ...
 */
extern int8 rtl8306e_port_port5LinkStatus_set(uint8 enabled) ;
 ...
 *      Port 5 should be manully enable / disable
 */
extern int8 rtl8306e_port_port5LinkStatus_get(uint8 *pEnabled);
 ...
 */
extern int8 rtl8306e_port_phyLinkStatus_get(uint8 phy, uint8 *plinkUp);
...
extern int8 rtl8306e_port_phyAutoNegotiationDone_get(uint8 phy, uint8 *pDone) ;
 ...
 */
extern int8 rtl8306e_port_phyLoopback_set(uint8 phy, uint8 enabled);
 ...
 *
 */
extern int8 rtl8306e_port_phyLoopback_get(uint8 phy, uint8 *pEnabled) ;
 ...
 *
 */
extern int8 rtl8306e_portLearningAbility_set(uint8 port, uint8 enabled);
 ...
 *      bit 14 - Port4 & Port5
 */
extern int8 rtl8306e_port_isolation_set(uint16 isomsk);
 ...
 *      bit 14 - Port4 & Port5
 */
extern int8 rtl8306e_port_isolation_get(uint16 *pIsomsk);
 ...
 */
extern int8 rtl8306e_vlan_tagAware_set(uint8 enabled);
 ...
 *      and assigned PVID as VID.
 */
extern int8 rtl8306e_vlan_tagAware_get(uint8 * pEnabled);
 ...
 *
 */
extern int8 rtl8306e_vlan_IgrFilterEnable_set(uint8 enabled);
 ...
 *
 */
extern int8 rtl8306e_vlan_IgrFilterEnable_get(uint8 *pEnabled);
 ...
 */
extern int8 rtl8306e_vlan_leaky_set(uint8 type, uint8 enabled);
 ...
 *    ignoring the VLAN member set domain limitation.
 */
extern int8 rtl8306e_vlan_leaky_get(uint8 type, uint8 *pEnabled);
 ...
 */
extern int8 rtl8306e_vlan_nullVidReplace_set(uint8 port, uint8 enabled);
 ...
 *      frame depends on the configuration.
 */
extern int8 rtl8306e_vlan_nullVidReplace_get(uint8 port, uint8 *pEnabled);
...
extern int8 rtl8306e_vlan_portPvidIndex_set(uint8 port, uint8 vlanIndex);
...
extern int8 rtl8306e_vlan_portPvidIndex_get(uint8 port, uint16 *pVlanIndex);
 ...
 */
extern int8 rtl8306e_vlan_portAcceptFrameType_set(uint8 port, rtl8306e_acceptFrameType_t accept_frame_type);
 ...
 *    RTL8306E_ACCEPT_UNTAG_ONLY
 */
extern int8 rtl8306e_vlan_portAcceptFrameType_get(uint8 port, rtl8306e_acceptFrameType_t *pAccept_frame_type);
 ...
 */
extern int8 rtl8306e_vlan_tagInsert_set(uint8 egPort, uint8 igPortMsk);
 ...
 *      is in the igPortMsk, it will be inserted with an VLAN tag.
 */
extern int8 rtl8306e_vlan_tagInsert_get(uint8 egPort, uint8 * pIgPortMsk);
 ...
 */
extern int8 rtl8306e_vlan_entry_set(uint8 vlanIndex, uint16 vid, uint8 mbrmsk, uint8 untagmsk );
 ...
 *     For example, mbrmask 23=0x17=010111 means port 0,1,2,4 in the member set.
 */
extern int8 rtl8306e_vlan_entry_get(uint8 vlanIndex, uint16 *pVid, uint16 *pMbrmsk, uint16 *pUntagmsk);
 ...
 *       
 */
extern int8 rtl8306e_vlan_vlanBasedPriority_set(uint8 vlanIndex, uint8 pri);
 ...
 *       
 */
extern int8 rtl8306e_vlan_vlanBasedPriority_get(uint8 vlanIndex, uint8 *pPri);
 ...
 */
extern int8 rtl8306e_vlan_transEnable_set(uint8 enable, uint8 portmask);
 ...
 *      at the same time, user should choose one of them. 
 */
extern int8 rtl8306e_vlan_transEnable_get(uint8 *pEnable, uint8 *pPortMask);
 ...
 * Note:
 */
extern int8 rtl8306e_vlan_transparentEnable_set(uint8 enable);
 ...
 *      new VID.
 */ 
extern int8 rtl8306e_vlan_transVid_set(uint8 vlanIndex, uint16 transVid);
 ...
 *      new VID.
 */ 
extern int8 rtl8306e_vlan_transVid_get(uint8 vlanIndex, uint16 *pTransVid);
 ...
 *       
 */
extern int8 rtl8306e_svlan_tagAdmit_set(uint8 port, uint8 enable);
 ...
 *       
 */
extern int8 rtl8306e_svlan_tagAdmit_get(uint8 port, uint8 *pEnable);
 ...
 */
extern int8 rtl8306e_svlan_otagSrc_set(uint8 port, uint16 ovidSrc, uint16 opriSrc);
 ...
 *       opriSrc  RTL8306E_PRISRC_PPRI   : opri is port-based priority, RTL8306E_PRISRC_1PRMK: opri is 1p remarking value
 */
extern int8 rtl8306e_svlan_otagSrc_get(uint8 port, uint16 *pOvidsrc, uint16 *pOpriSrc);
 ...
 */
extern int8 rtl8306e_cpu_set(uint8 port, uint8 enTag) ;
...
extern int8 rtl8306e_cpu_get(uint8 *pPort, uint8 *pEnTag) ;
 ...
 *      reset packet buffer.
 */
extern int8 rtl8306e_qos_softReset_set(void) ;
 ...
 */
extern int8 rtl8306e_qos_queueNum_set(uint8 num);
 ...
 *      Queue number is global configuration for switch.
 */
extern int8 rtl8306e_qos_queueNum_get(uint8 *pNum) ;
 ...
 */
extern int8 rtl8306e_qos_priToQueMap_set(uint8 priority, uint8 qid) ;
 ...
 *      we can use this function to set pkt priority with queue id mapping
 */
extern int8 rtl8306e_qos_priToQueMap_get(uint8 priority, uint8 *pQid) ;
 ...
 */
extern int8 rtl8306e_qos_portRate_set(uint8 port, uint16 n64Kbps, uint8 direction, uint8 enabled);
 ...
 *      is configured per port, but for input rate control, it is for all port.
 */
extern int8 rtl8306e_qos_portRate_get(uint8 port, uint16 *pN64Kbps, uint8 direction, uint8 *pEnabled);
 ...
 *      
 */
extern int8 rtl8306e_qos_1pRemarkEnable_set(uint8 port, uint8 enabled);
 ...
 *      
 */
extern int8 rtl8306e_qos_1pRemarkEnable_get(uint8 port, uint8 *pEnabled) ;
 ...
 *      cpu tag.
 */
extern int8 rtl8306e_qos_1pRemark_set(uint8 priority, uint8 priority1p);
 ...
 *      cpu tag.
 */
extern int8 rtl8306e_qos_1pRemark_get(uint8 priority, uint8 *pPriority1p);
 ...
 */
extern int8 rtl8306e_qos_portPri_set(uint8 port, uint8 priority);
 ...
 *      packet will be assigned a port-based priority correspond to the ingress port.
 */ 
extern int8 rtl8306e_qos_portPri_get(uint8 port, uint8 *pPriority);
 ...
 *      to 2-bit priority
 */ 
extern int8 rtl8306e_qos_1pPriRemap_set(uint8 tagprio, uint8 prio) ;
 ...
 *      to 2-bit priority
 */ 
extern int8 rtl8306e_qos_1pPriRemap_get(uint8 tagprio, uint8 *pPrio);
 ...
 *     
 */ 
extern int8 rtl8306e_qos_dscpPriRemap_set(uint8 dscpcode, uint8 priority) ;
 ...
 *     
 */ 
extern int8 rtl8306e_qos_dscpPriRemap_get(uint8 dscpcode, uint8 *pPriority);
 ...
 */
extern int8 rtl8306e_qos_priSrcArbit_set(rtl8306e_qosPriArbitPara_t priArbit);
 ...
 *      will not be recognized any more. 
 */
extern int8 rtl8306e_qos_priSrcArbit_get(rtl8306e_qosPriArbitPara_t *pPriArbit);
 ...
 *          RTL8306_CPUTAG_PRIO  - cpu tag priority
 */
extern int8 rtl8306e_qos_priSrcEnable_set(uint8 port, uint8 priSrc, uint8 enabled);
 ...
 *          RTL8306_CPUTAG_PRIO  - cpu tag priority
 */
extern int8 rtl8306e_qos_priSrcEnable_get(uint8 port, uint8 priSrc, uint8 *pEnabled);
 ...
 * Note:
 */
extern int8 rtl8306e_qos_ipAddrPri_set(uint8 priority);
 ...
 * Note:
 */
extern int8 rtl8306e_qos_ipAddrPri_get(uint8 *priority);
 ...
 */
extern int8 rtl8306e_qos_ipAddr_set(uint8 entry, uint32 ip, uint32 mask, uint8 enabled);
 ...
 * Note:
 */
extern int8 rtl8306e_qos_ipAddr_get(uint8 entry, uint32 *pIp, uint32 *pMask , uint8 *pEnabled);
 ...
 */
extern int8 rtl8306e_qos_schedulingPara_set(uint8 set, rtl8306e_qosSchPara_t sch_para);
 ...
 *      and q3_n64Kbps means Q2/Q3 queue bandwidth control, unit is 64Kbps.
 */
extern int8 rtl8306e_qos_schedulingPara_get(uint8 set, rtl8306e_qosSchPara_t *pSch_para);
 ...
 */
extern int8 rtl8306e_qos_portSchedulingMode_set(uint8 port, uint8 set, uint8 lbmsk);
 ...
 *      queue 3 and set 1 to enable it.
 */
extern int8 rtl8306e_qos_portSchedulingMode_get(uint8 port, uint8 *pSet, uint8 *pLbmsk);
extern int8 rtl8306e_qos_queFlcThr_set(uint8 queue, uint8 type, uint8 onoff, uint8 set, uint8 value);
extern int8 rtl8306e_qos_queFlcThr_get(uint8 queue, uint8 type, uint8 onoff, uint8 set, uint8* pValue);
extern int8 rtl8306e_qos_portFlcThr_set(uint8 port, uint8 onthr, uint8 offthr, uint8 direction );
extern int8 rtl8306e_qos_portFlcThr_get(uint8 port, uint8 *pOnthr, uint8 *pOffthr, uint8 direction);
extern int8 rtl8306e_qos_queFlcEnable_set( uint8 port, uint8 queue, uint8 enabled);
extern int8 rtl8306e_qos_queFlcEnable_get(uint8 port, uint8 queue, uint8 *pEnabled);
 ...
 *       
 */
extern int8 rtl8306e_acl_entry_set(uint8 entryadd, uint8 phyport, uint8 action, uint8 protocol, uint16 value, uint8 priority) ;
 ...
 *       
 */
extern int8 rtl8306e_acl_entry_get(uint8 entryadd, uint8 *pPhyport, uint8 *pAction, uint8 *pProtocol, uint16  *pData, uint8 *pPriority);
 ...
 */
extern int8 rtl8306e_mib_get(uint8 port, uint8 counter, uint32 *pValue);
 ...
 */
extern int8 rtl8306e_mibUnit_set(uint8 port, uint8 counter, uint8 unit);
 ...
 *      the other counters' counting uint is RTL8306_MIB_PKT
 */
extern int8 rtl8306e_mibUnit_get(uint8 port, uint8 counter, uint8 *pUnit);
 ...
 * Note:
 */
extern int8 rtl8306e_mib_reset(uint8 port);
 ...
 */
extern int8 rtl8306e_mirror_portBased_set(uint8 mirport, uint8 rxmbr, uint8 txmbr) ;
...
extern int8 rtl8306e_mirror_portBased_get(uint8 *pMirport, uint8 *pRxmbr, uint8* pTxmbr);
 ...
 */
extern int8 rtl8306e_l2_MacToIdx_get(uint8 *macAddr, uint16* pIndex);
 ...
 */ 
extern int8 rtl8306e_l2_unicastEntry_set(uint8 *macAddress, uint8 entry, uint8 age, uint8 isStatic, uint8 isAuth, uint8 port);
 ...
 *          RTL8306_LUT_AGE300(300s)
 */ 
extern int8 rtl8306e_l2_unicastEntry_get(uint8 *macAddress, uint16 entryAddr, uint8 *pAge, uint8 *pIsStatic, uint8 *pIsAuth, uint8 *pPort) ;
...
extern int8 rtl8306e_l2_multicastEntry_set(uint8 *macAddress, uint8 entry, uint8 isAuth, uint8 portMask);
 ...
 *      Get multicast entry
 */ 
extern int8 rtl8306e_l2_multicastEntry_get(uint8 *macAddress, uint16 entryAddr, uint8 *pIsAuth, uint8 *pPortMask);
 ...
 */ 
extern int8 rtl8306e_l2_unicastMac_add(uint8 *macAddress, uint8 age, uint8 isStatic, uint8 isAuth, uint8 port, uint8 *pEntryaddr);
 ...
 */ 
extern int8 rtl8306e_l2_multicastMac_add(uint8 *macAddr,uint8 isAuth, uint8 portMask, uint8 *pEntryaddr);
 ...
 */ 
extern int8 rtl8306e_l2_mac_get(uint8 *macAddr, uint8 *pIsStatic, uint8 *pIsAuth, uint8 *pPortInfo, uint8 *pEntryaddr);
...
extern int8 rtl8306e_l2_mac_del(uint8 *macAddr, uint8 *pEntryaddr);
extern int8 rtl8306e_l2_portMacLimit_set(uint8 port, uint8 enabled, uint8 macCnt) ;
extern int8 rtl8306e_l2_portMacLimit_get(uint8 port, uint8 *pEnabled, uint8 *pMacCnt);
extern int8 rtl8306e_l2_systemMacLimit_set(uint8 enabled, uint8 macCnt, uint8 mergMask);
extern int8 rtl8306e_l2_systemMacLimit_get(uint8 *pEnabled, uint8 *pMacCnt, uint8 *pMergMask);
extern int8 rtl8306e_l2_macLimitAction_set(uint8 action);
extern int8 rtl8306e_l2_macLimitAction_get(uint8 *pAction);
 ...
 *          RTL8306_LUT_AGE300(300s)
 */ 
extern int8 rtl8306e_fastGetAsicLUTUnicastEntry(uint8 *macAddress, uint8 entryAddr, uint8 *age, uint8 *isStatic, uint8 *isAuth, uint8 *port);
 ...
 *      and bit 5 corresponds port 5.    
 */ 
extern int8 rtl8306e_fastGetAsicLUTMulticastEntry(uint8 *macAddress, uint8 entryAddr, uint8 *isAuth, uint8 *portMask);
 ...
 */ 
extern int8 rtl8306e_stp_set(uint8 port, uint8 state) ;
 ...
 *         RTL8306_SPAN_FORWARD - Forwarding state
 */ 
extern int8 rtl8306e_stp_get(uint8 port, uint8 *pState) ;
 ...
 */ 
extern int8 rtl8306e_dot1x_portBased_set(uint8 port, uint8 enabled, uint8 isAuth, uint8 direction);
 ...
 *                                              port's traffic to unauthorized port
 */ 
extern int8 rtl8306e_dot1x_portBased_get(uint8 port, uint8 *pEnabled, uint8 *pIsAuth, uint8 *pDirection) ;
...
extern int8 rtl8306e_dot1x_macBased_set(uint8 port, uint8 enabled, uint8 direction);
 ...
 *      unauthorized DA will pass mac-based access control igress rule.
 */ 
extern int8 rtl8306e_dot1x_macBased_get(uint8 port, uint8 *pEnabled, uint8 *pDirection);
 ...
 */ 
extern int8 rtl8306e_trap_igmpCtrlPktAction_set(uint8 type, uint8 action);
 ...
 *          RTL8306_ACT_TRAPCPU  - trap to cpu
 */ 
extern int8 rtl8306e_trap_igmpCtrlPktAction_get(uint8 type, uint8 *pAction);
 ...
 *          RTL8306_ACT_PERMIT   - normal forward
 */  
extern int8 rtl8306e_trap_unknownIPMcastPktAction_set(uint8 type, uint8 action);
 ...
 *          RTL8306_ACT_PERMIT   - normal forward
 */ 
extern int8 rtl8306e_trap_unknownIPMcastPktAction_get(uint8 type, uint8 *pAction);
 ...
 *          RTL8306_ACT_TRAPCPU  - trap to cpu
 */ 
extern int8 rtl8306e_trap_abnormalPktAction_set(uint8 type,  uint8 action);
...
extern int8 rtl8306e_trap_abnormalPktAction_get(uint8 type,  uint8 *pAction);
 ...
 *            RTL8306_ACT_FLOOD   - Flood the packet
 */ 
extern int8 rtl8306e_trap_rmaAction_set(uint8 type, uint8 action);
 ...
 *            RTL8306_ACT_FLOOD   - Flood the packet
 */ 
extern int8 rtl8306e_trap_rmaAction_get(uint8 type, uint8 *pAction);
 ...
 *
 */ 
extern int8 rtl8306e_int_control_set(uint8 enInt, uint16 intmask);
 ...
 *
 */ 
extern int8 rtl8306e_int_control_get(uint8 *pEnInt, uint16 *pIntmask);
 ...
 *
 */ 
extern int8 rtl8306e_int_status_get(uint16 *pStatusMask);
 ...
 */ 
extern int8 rtl8306e_storm_filterEnable_set(uint8 type, uint8 enabled);
...
extern int8 rtl8306e_storm_filterEnable_get(uint8 type, uint8 *pEnabled);
...
extern int8 rtl8306e_storm_filter_set(uint8 trigNum, uint8 filTime, uint8 enStmInt);
...
extern int8 rtl8306e_storm_filter_get(uint8 *pTrigNum, uint8 *pFilTime, uint8 *pEnStmInt);

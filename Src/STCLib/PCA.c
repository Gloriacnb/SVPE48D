...
idata u8 PCA2_mode;
idata u16 CCAP0_tmp;
idata u16 PCA_Timer0;
idata u16 CCAP1_tmp;
idata u16 PCA_Timer1;
idata u16 CCAP2_tmp;
idata u16 PCA_Timer2;
...
idata u16 PWM0_low;	//PWM输出低电平的PCA时钟脉冲个数, 用户层不可见。
idata u16 PWM1_low;	//PWM输出低电平的PCA时钟脉冲个数, 用户层不可见。
idata u16 PWM2_low;	//PWM输出低电平的PCA时钟脉冲个数, 用户层不可见。
